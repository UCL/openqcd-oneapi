...
int main(int argc, char *argv[])
{
  ...
  ie = check_bc(0.0);
  error(ie != 1, 1, "main [check2.c]", "check_bc() gives the wrong answer");

  new_fld(0);
  ie = check_bc(0.0);
  error(((bc < 2) && (ie != 0)) || ((bc >= 2) && (ie != 1)), 2,
        "main [check2.c]", "check_bc() gives the wrong answer");

  new_fld(1);
  ie = check_bc(0.0);
  error(((bc < 3) && (ie != 0)) || ((bc == 3) && (ie != 1)), 2,
        "main [check2.c]", "check_bc() gives the wrong answer");

  cm3x3_assign(4 * VOLUME, udb, usv[0]);
  set_bc();
  ie = check_bc(0.0);
  error(ie != 1, 2, "main [check2.c]", "check_bc() gives the wrong answer");
  ...
  ie = chs_ubnd(-1);
  error(((bc == 3) && (ie == 0)) || ((bc != 3) && (ie == 1)), 1,
        "main [check2.c]", "Incorrect return value of chs_ubnd()");
  ...
  ie = chs_ubnd(1);
  error(ie != 0, 3, "main [check2.c]", "Incorrect return value of chs_ubnd()");
