...
int main(int argc, char *argv[])
{
  ...
  mulr_spinor_add_dble(VOLUME / 2, psd[2] + (VOLUME / 2), psd[3] + (VOLUME / 2),
                       -1.0);
  ...
  mulr_spinor_add_dble(VOLUME / 2, psd[2] + (VOLUME / 2), psd[4] + (VOLUME / 2),
                       -1.0);
  d = norm_square_dble(VOLUME, 1, psd[2]);
  ...
  mulr_spinor_add_dble(VOLUME / 2, psd[3] + (VOLUME / 2), psd[4] + (VOLUME / 2),
                       1.0);
  ...
  d = norm_square_dble(VOLUME / 2, 1, psd[1]) /
  ...
  mulr_spinor_add_dble(VOLUME / 2, psd[1] + (VOLUME / 2), psd[3] + (VOLUME / 2),
                       -1.0);
