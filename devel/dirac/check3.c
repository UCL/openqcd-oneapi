...
int main(int argc, char *argv[])
{
  ...
  mulr_spinor_add(VOLUME / 2, ps[2] + (VOLUME / 2), ps[3] + (VOLUME / 2),
                  -1.0f);
  ...
  mulr_spinor_add(VOLUME / 2, ps[2] + (VOLUME / 2), ps[4] + (VOLUME / 2),
                  -1.0f);
  d = norm_square(VOLUME, 1, ps[2]);
  ...
  Dweo(ps[2], ps[1]);
  Dwoe(ps[2], ps[3]);
  mulr_spinor_add(VOLUME / 2, ps[1] + (VOLUME / 2), ps[3] + (VOLUME / 2),
                  -1.0f);
  Dwoo(0.0f, ps[2], ps[3]);
  mulr_spinor_add(VOLUME / 2, ps[1] + (VOLUME / 2), ps[3] + (VOLUME / 2),
                  -1.0f);
