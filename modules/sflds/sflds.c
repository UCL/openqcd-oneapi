...
void set_sd2zero(int vol, spinor_dble *sd)
{
  ...
  for (; sd < sm; sd++) {
    __asm__ __volatile__("movapd %%xmm0, %0 \n\t"
                         ...
                         "movapd %%xmm1, %4 \n\t"
                         "movapd %%xmm2, %5"
                         : "=m"((*sd).c1.c1), "=m"((*sd).c1.c2),
                           "=m"((*sd).c1.c3), "=m"((*sd).c2.c1),
                           "=m"((*sd).c2.c2), "=m"((*sd).c2.c3));
    ...
    __asm__ __volatile__("movapd %%xmm0, %0 \n\t"
                         ...
                         "movapd %%xmm1, %4 \n\t"
                         "movapd %%xmm2, %5"
                         : "=m"((*sd).c3.c1), "=m"((*sd).c3.c2),
                           "=m"((*sd).c3.c3), "=m"((*sd).c4.c1),
                           "=m"((*sd).c4.c2), "=m"((*sd).c4.c3));
  }
}
...
void assign_s2sd(int vol, spinor *s, spinor_dble *rd)
{
  ...
  for (; rd < rm; rd++) {
    ...
    __asm__ __volatile__("movhlps %%xmm0, %%xmm1 \n\t"
                         ...
                         :
                         :
                         : "xmm1", "xmm3", "xmm5", "xmm7", "xmm9", "xmm10");
    ...
    __asm__ __volatile__("movapd %%xmm0, %0 \n\t"
                         ...
                         "movapd %%xmm4, %4 \n\t"
                         "movapd %%xmm5, %5"
                         : "=m"((*rd).c1.c1), "=m"((*rd).c1.c2),
                           "=m"((*rd).c1.c3), "=m"((*rd).c2.c1),
                           "=m"((*rd).c2.c2), "=m"((*rd).c2.c3));
    ...
    __asm__ __volatile__("movapd %%xmm6, %0 \n\t"
                         ...
                         "movapd %%xmm10, %4 \n\t"
                         "movapd %%xmm11, %5"
                         : "=m"((*rd).c3.c1), "=m"((*rd).c3.c2),
                           "=m"((*rd).c3.c3), "=m"((*rd).c4.c1),
                           "=m"((*rd).c4.c2), "=m"((*rd).c4.c3));
  }
}
...
void assign_sd2s(int vol, spinor_dble *sd, spinor *r)
{
  ...
  for (; r < rm; r++) {
    __asm__ __volatile__("movapd %0, %%xmm0 \n\t"
                         ...
                         "movapd %5, %%xmm5"
                         :
                         : "m"((*sd).c1.c1), "m"((*sd).c1.c2), "m"((*sd).c1.c3),
                           "m"((*sd).c2.c1), "m"((*sd).c2.c2), "m"((*sd).c2.c3)
                         : "xmm0", "xmm1", "xmm2", "xmm3", "xmm4", "xmm5");
    ...
    __asm__ __volatile__("movapd %0, %%xmm6 \n\t"
                         ...
                         "movapd %5, %%xmm11"
                         :
                         : "m"((*sd).c3.c1), "m"((*sd).c3.c2), "m"((*sd).c3.c3),
                           "m"((*sd).c4.c1), "m"((*sd).c4.c2), "m"((*sd).c4.c3)
                         : "xmm6", "xmm7", "xmm8", "xmm9", "xmm10", "xmm11");
    ...
    __asm__ __volatile__("movlhps %%xmm1, %%xmm0 \n\t"
                         ...
                         :
                         :
                         : "xmm0", "xmm2", "xmm4", "xmm6", "xmm8", "xmm10");
...
void add_s2sd(int vol, spinor *s, spinor_dble *rd)
{
  ...
  for (; rd < rm; rd++) {
    ...
    __asm__ __volatile__("addpd %0, %%xmm0 \n\t"
                         ...
                         "addpd %5, %%xmm5"
                         :
                         : "m"((*rd).c1.c1), "m"((*rd).c1.c2), "m"((*rd).c1.c3),
                           "m"((*rd).c2.c1), "m"((*rd).c2.c2), "m"((*rd).c2.c3)
                         : "xmm0", "xmm1", "xmm2", "xmm3", "xmm4", "xmm5");
    ...
    __asm__ __volatile__("addpd %0, %%xmm6 \n\t"
                         ...
                         "addpd %5, %%xmm11"
                         :
                         : "m"((*rd).c3.c1), "m"((*rd).c3.c2), "m"((*rd).c3.c3),
                           "m"((*rd).c4.c1), "m"((*rd).c4.c2), "m"((*rd).c4.c3)
                         : "xmm6", "xmm7", "xmm8", "xmm9", "xmm10", "xmm11");
