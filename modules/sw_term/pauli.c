...
void mul_pauli2(float mu, pauli const *m, spinor const *source, spinor *res)
{
  ...
  register __m512 tr1, tr2, tr3;
  register __m512 ts1, ts2, ts3, tsi1, tsi2, tsi3, u512;
  ...
  __m512i idx =
      _mm512_setr_epi32(0, 1, 2, 3, 6, 7, 8, 9, 12, 13, 14, 15, 18, 19, 20, 21);
  ts1 = _mm512_permutex2var_ps(tr1, idx, tr2);
  idx = _mm512_setr_epi32(2, 3, 4, 5, 8, 9, 10, 11, 14, 15, 16, 17, 20, 21, 22,
                          23);
  ts2 = _mm512_permutex2var_ps(tr1, idx, tr2);
  idx = _mm512_setr_epi32(4, 5, 0, 1, 10, 11, 6, 7, 16, 17, 12, 13, 22, 23, 18,
                          19);
  ts3 = _mm512_permutex2var_ps(tr1, idx, tr2);

  __m512 tu11 = _mm512_loadu_ps(u);
  __m512 tu12 = _mm512_loadu_ps(u + 16);
  __m512 tu13 = _mm512_loadu_ps(u + 32);
  __m512 tu21 = _mm512_loadu_ps(u2);
  __m512 tu22 = _mm512_loadu_ps(u2 + 16);
  __m512 tu23 = _mm512_loadu_ps(u2 + 32);

  tsi1 = _mm512_permute_ps(ts1, 0b10110001);
  tsi2 = _mm512_permute_ps(ts2, 0b10110001);
  tsi3 = _mm512_permute_ps(ts3, 0b10110001);

  __m128 tmu = _mm_load_ps1(&mu);
  __m512 umu = _mm512_broadcastss_ps(tmu);

  __m512 tu1, tu2, tu3, tu4;

  idx = _mm512_setr_epi32(0, 1, 10, 11, 4, 5, 2, 3, 16, 17, 26, 27, 20, 21, 18,
                          19);
  tu1 = _mm512_permutex2var_ps(tu11, idx, tu21);
  idx = _mm512_setr_epi32(4, 5, 0, 1, 12, 13, 6, 7, 20, 21, 16, 17, 28, 29, 22,
                          23);
  tu2 = _mm512_permutex2var_ps(tu12, idx, tu22);

  idx = _mm512_setr_epi32(0, 0, 1, 1, 2, 3, 16 + 0, 16 + 1, 8, 8, 9, 9, 10, 11,
                          16 + 8, 16 + 9);
  tu4 = _mm512_permutex2var_ps(tu1, idx, tu2);
  u512 = _mm512_permute_ps(tu4, 0b10100000);
  tr1 = _mm512_mul_ps(ts1, u512);

  idx = _mm512_setr_epi32(0, 1, 2, 3, 16 + 5, 16 + 5, 16 + 7, 16 + 7, 8, 9, 10,
                          11, 16 + 13, 16 + 13, 16 + 15, 16 + 15);
  ...
  idx = _mm512_setr_epi32(0, 0, 4, 4, 16 + 4, 16 + 4, 16 + 5, 16 + 5, 8, 8, 12,
                          12, 16 + 12, 16 + 12, 16 + 13, 16 + 13);
  u512 = _mm512_permutex2var_ps(tu2, idx, tu1);
  tr2 = _mm512_mul_ps(ts2, u512);

  idx = _mm512_setr_epi32(1, 1, 5, 5, 16 + 4, 16 + 5, 16 + 6, 16 + 7, 9, 9, 13,
                          13, 16 + 12, 16 + 13, 16 + 14, 16 + 15);
  ...
  idx = _mm512_setr_epi32(6, 6, 2, 3, 16 + 4, 16 + 5, 7, 7, 14, 14, 10, 11,
                          16 + 12, 16 + 13, 15, 15);
  tu4 = _mm512_permutex2var_ps(tu1, idx, tu2);
  u512 = _mm512_permute_ps(tu4, 0b10100000);
  tr3 = _mm512_mul_ps(ts3, u512);

  idx = _mm512_setr_epi32(0, 1, 16 + 3, 16 + 3, 16 + 5, 16 + 5, 6, 7, 8, 9,
                          16 + 11, 16 + 11, 16 + 13, 16 + 13, 14, 15);
  u512 = _mm512_permutex2var_ps(umu, idx, tu4);
  ...
  idx = _mm512_setr_epi32(8, 9, 6, 7, 14, 15, 12, 13, 24, 25, 22, 23, 30, 31,
                          28, 29);
  tu1 = _mm512_permutex2var_ps(tu11, idx, tu21);
  ...
  idx =
      _mm512_setr_epi32(0, 1, 2, 3, 0, 1, 2, 3, 16, 17, 18, 19, 16, 17, 18, 19);
  tu13 = _mm512_permutex2var_ps(tu13, idx, tu23);
  idx = _mm512_setr_epi32(6, 7, 2, 3, 8, 9, 14, 15, 22, 23, 18, 19, 24, 25, 30,
                          31);
  tu2 = _mm512_permutex2var_ps(tu12, idx, tu22);

  idx = _mm512_setr_epi32(6, 7, 16 + 0, 16 + 1, 16 + 6, 16 + 7, 0, 0, 14, 15,
                          16 + 8, 16 + 9, 16 + 14, 16 + 15, 0, 0);
  ...
  idx = _mm512_setr_epi32(0, 1, 2, 3, 4, 5, 16 + 2, 16 + 3, 8, 9, 10, 11, 12,
                          13, 16 + 10, 16 + 11);
  tu3 = _mm512_permutex2var_ps(tu1, idx, tu2);
  u512 = _mm512_permute_ps(tu3, 0b10100000);
  ...
  idx = _mm512_setr_epi32(0, 1, 8, 9, 10, 11, -1, -1, 16, 17, 24, 25, 26, 27,
                          -1, -1);
  tu2 = _mm512_permutex2var_ps(tu12, idx, tu22);

  idx = _mm512_setr_epi32(4, 5, 16 + 4, 16 + 5, 0, 0, 0, 0, 12, 13, 16 + 12,
                          16 + 13, 0, 0, 0, 0);
  ...
  idx = _mm512_setr_epi32(0, 1, 2, 3, 16, 17, 18, 19, 8, 9, 10, 11, 24, 25, 26,
                          27);
  ts1 = _mm512_permutex2var_ps(tr1, idx, tr3);
  idx = _mm512_setr_epi32(4, 5, 6, 7, 20, 21, 22, 23, 12, 13, 14, 15, 28, 29,
                          30, 31);
  ts2 = _mm512_permutex2var_ps(tr1, idx, tr3);
  ts3 = _mm512_add_ps(ts1, ts2);

  __m256 t256 = _mm512_castps512_ps256(ts3);
  _mm256_storeu_ps(&(*r).c1.c1.re, t256);

  __m128 t128a = _mm512_castps512_ps128(tr2);
  __m128 t128b = _mm512_extractf32x4_ps(tr2, 1);
