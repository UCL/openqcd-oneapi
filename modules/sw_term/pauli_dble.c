                     ...
                     weyl_dble *r)
{
  ...
  register __m512d s1, s2, s3, s4, s5, s6, si1, si2, si3, si4, si5, si6, s512,
      u512;
  ...
  __m512d tu11 = _mm512_loadu_pd(u);
  __m512d tu12 = _mm512_loadu_pd(u + 8);
  __m512d tu13 = _mm512_loadu_pd(u + 16);
  __m512d tu14 = _mm512_loadu_pd(u + 24);
  __m512d tu15 = _mm512_loadu_pd(u + 32);
  __m512d tu21 = _mm512_loadu_pd(u2);
  __m512d tu22 = _mm512_loadu_pd(u2 + 8);
  __m512d tu23 = _mm512_loadu_pd(u2 + 16);
  __m512d tu24 = _mm512_loadu_pd(u2 + 24);
  __m512d tu25 = _mm512_loadu_pd(u2 + 32);

  __m512d umu = _mm512_loadu_pd(&mu);
  ...
  __m512d tu1 = _mm512_permutex2var_pd(tu11, idx, tu21);
  idx = _mm512_setr_epi64(4, 5, 12, 13, 2, 3, 10, 11);
  __m512d tu2 = _mm512_permutex2var_pd(tu12, idx, tu22);
  ...
  __m512d tu6 = _mm512_permutex2var_pd(tu11, idx, tu21);
  ...
  __m512d tu3 = _mm512_permutex2var_pd(tu13, idx, tu23);
  ...
  __m512d tu4 = _mm512_permutex2var_pd(tu14, idx, tu24);
  ...
  __m512d tu5 = _mm512_permutex2var_pd(tu15, idx, tu25);
  ...
  _mm512_store_pd(&r[0].c1.c1.re, r1);
  _mm512_store_pd(&r[0].c2.c2.re, r2);
  _mm512_store_pd(&r[1].c1.c3.re, r3);
}
  ...
  for (k = 0; k < 5; k++) {
    ...
    for (j = (k + 1); j < 6; j++) {
      ...
      for (i = k; i < 6; i++) {
        ...
        mz = _mm_add_pd(mz, t1);
        /*z.re += (ak[0].re * aj[0].re + ak[0].im * aj[0].im);
        z.im += (ak[0].re * aj[0].im - ak[0].im * aj[0].re);*/
        ak += 6;
        aj += 6;
      }
      ...
      for (i = k; i < 6; i++) {
        ...
        t3 = _mm_sub_pd(t3, t1);
        _mm_store_pd(&aj->re, t3);
        /*aa[6 * i + j].re -= (z.re * aa[6 * i + k].re - z.im * aa[6 * i +
        k].im);
        aa[6 * i + j].im -= (z.re * aa[6 * i + k].im + z.im * aa[6 * i +
        k].re);*/
        ak += 6;
        aj += 6;
      }
  ...
  for (k = 5; k > 0; k--) {
    for (i = (k - 1); i >= 0; i--) {
      ...
      for (j = (k - 1); j > i; j--) {
        ...
        mz = _mm_add_pd(mz, t1);
        /*z.re += aa[ 6*i+j ].re * aa[ 6*j+k ].re - aa[ 6*i+j ].im * aa[ 6*j+k
          ].im; z.im += aa[ 6*i+j ].re * aa[ 6*j+k ].im + aa[ 6*i+j ].im * aa[
          6*j+k ].re;*/
      }
      ...
      t1 =
          _mm_sub_pd(_mm_setzero_pd(), t1); /* this line flips the sign of t1 */
      _mm_store_pd(&aa[6 * i + k].re, t1);
  ...
  for (k = 4; k >= 0; k--) {
    ...
    for (i = 0; i < 6; i++) {
      ...
      for (j = k; j < 6; j++) {
        ...
        t1 = _mm_sub_pd(t2, t1);
        _mm_store_pd(&aa[6 * i + j].re, t1);
        /*aa[6 * i + j].re -= z.re * dd[j].re + z.im * dd[j].im;
          aa[6 * i + j].im -= z.im * dd[j].re - z.re * dd[j].im;*/
      }
    }
  }
}
                    ...
                    weyl_dble *r)
{
  ...
  __asm__ __volatile__(
      ...
      :
      : "m"((*m).u[6]), "m"((*m).u[7]), "m"((*m).u[16]), "m"((*m).u[17]),
        "m"((*s).c1.c1.re), "m"((*s).c1.c1.im), "m"((*s).c1.c2.re),
        "m"((*s).c1.c2.im)
      : "xmm0", "xmm1", "xmm2", "xmm3", "xmm4", "xmm8", "xmm9", "xmm10");
  ...
  __asm__ __volatile__("vmovapd %0, %%ymm12 \n\t"
                       ...
                       : "m"((*m).u[16]), "m"((*m).u[17]), "m"((*m).u[18]),
                         ...
                         "m"((*s).c1.c3.re), "m"((*s).c1.c3.im),
                         "m"((*s).c2.c1.re), "m"((*s).c2.c1.im)
  ...
  __asm__ __volatile__("vmovupd %0, %%ymm13 \n\t"
                       ...
                       : "m"((*m).u[26]), "m"((*m).u[27]), "m"((*m).u[28]),
                         "m"((*m).u[29]), "m"((*s).c2.c2.re),
                         "m"((*s).c2.c2.im), "m"((*s).c2.c3.re),
                         "m"((*s).c2.c3.im)
  ...
  __asm__ __volatile__("vaddsubpd %%ymm8, %%ymm5, %%ymm5 \n\t"
                       ...
                       :
                       : "xmm2", "xmm4", "xmm5", "xmm6", "xmm7", "xmm8", "xmm9",
                    ...
                    weyl_dble *r)
{
  ...
  __asm__ __volatile__("movddup %0, %%xmm6 \n\t"
                       ...
                       "movddup %5, %%xmm11"
                       :
                       : "m"((*m).u[7]), "m"((*m).u[17]), "m"((*m).u[25]),
                         "m"((*m).u[31]), "m"((*m).u[35]), "m"((*m).u[15])
  ...
  __asm__ __volatile__("mulpd %0, %%xmm6 \n\t"
                       ...
                       "subpd %%xmm11, %%xmm5"
                       :
                       : "m"((*s).c1.c2), "m"((*s).c1.c3), "m"((*s).c2.c1),
                         "m"((*s).c2.c2), "m"((*s).c2.c3), "m"((*s).c1.c1)
  ...
  __asm__ __volatile__("movddup %0, %%xmm6 \n\t"
                       ...
                       "movddup %5, %%xmm11"
                       :
                       : "m"((*m).u[9]), "m"((*m).u[19]), "m"((*m).u[27]),
                         "m"((*m).u[33]), "m"((*m).u[13]), "m"((*m).u[23])
                       : "xmm6", "xmm7", "xmm8", "xmm9", "xmm10", "xmm11");
  ...
  __asm__ __volatile__("mulpd %0, %%xmm6 \n\t"
                       ...
                       "subpd %%xmm11, %%xmm5"
                       :
                       : "m"((*s).c1.c3), "m"((*s).c2.c1), "m"((*s).c2.c2),
                         "m"((*s).c2.c3), "m"((*s).c1.c1), "m"((*s).c1.c2)
                       : "xmm0", "xmm1", "xmm2", "xmm3", "xmm4", "xmm5", "xmm6",
                         "xmm7", "xmm8", "xmm9", "xmm10", "xmm11");
  ...
  __asm__ __volatile__("movddup %0, %%xmm6 \n\t"
                       ...
                       "movddup %5, %%xmm11"
                       :
                       : "m"((*m).u[13]), "m"((*m).u[23]), "m"((*m).u[9]),
                         "m"((*m).u[19]), "m"((*m).u[27]), "m"((*m).u[33])
                       : "xmm6", "xmm7", "xmm8", "xmm9", "xmm10", "xmm11");
  ...
  __asm__ __volatile__("movddup %0, %%xmm6 \n\t"
                       ...
                       "movddup %5, %%xmm11"
                       :
                       : "m"((*m).u[15]), "m"((*m).u[7]), "m"((*m).u[17]),
                         "m"((*m).u[25]), "m"((*m).u[31]), "m"((*m).u[35])
                       : "xmm6", "xmm7", "xmm8", "xmm9", "xmm10", "xmm11");
  ...
  __asm__ __volatile__("movddup %0, %%xmm6 \n\t"
                       ...
                       "movddup %5, %%xmm11"
                       :
                       : "m"((*m).u[6]), "m"((*m).u[16]), "m"((*m).u[24]),
                         "m"((*m).u[30]), "m"((*m).u[34]), "m"((*m).u[14])
                       : "xmm6", "xmm7", "xmm8", "xmm9", "xmm10", "xmm11");
  ...
  __asm__ __volatile__("movddup %0, %%xmm6 \n\t"
                       ...
                       "movddup %5, %%xmm11"
                       :
                       : "m"((*m).u[8]), "m"((*m).u[18]), "m"((*m).u[26]),
                         "m"((*m).u[32]), "m"((*m).u[12]), "m"((*m).u[22])
                       : "xmm6", "xmm7", "xmm8", "xmm9", "xmm10", "xmm11");
  ...
  __asm__ __volatile__("movddup %0, %%xmm6 \n\t"
                       ...
                       "movddup %5, %%xmm11"
                       :
                       : "m"((*m).u[12]), "m"((*m).u[22]), "m"((*m).u[8]),
                         "m"((*m).u[18]), "m"((*m).u[26]), "m"((*m).u[32])
                       : "xmm6", "xmm7", "xmm8", "xmm9", "xmm10", "xmm11");
  ...
  __asm__ __volatile__("movddup %0, %%xmm6 \n\t"
                       ...
                       "movddup %5, %%xmm11"
                       :
                       : "m"((*m).u[14]), "m"((*m).u[6]), "m"((*m).u[16]),
                         "m"((*m).u[24]), "m"((*m).u[30]), "m"((*m).u[34])
                       : "xmm6", "xmm7", "xmm8", "xmm9", "xmm10", "xmm11");
...
static int fwd_house(double eps)
{
  ...
  for (k = 0; k < 5; k++) {
    ...
    for (j = (k + 1); j < 6; j++) {
      __asm__ __volatile__("xorpd %%xmm7, %%xmm7" : : : "xmm7");
