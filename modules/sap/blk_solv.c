  ...
  while (s1 < sm) {
    ...
    while (s1 < smb) {
      __asm__ __volatile__("vmovaps %0, %%ymm0 \n\t"
                           "vmovaps %4, %%ymm1"
                           :
                           : "m"((*s2).c1.c1), "m"((*s2).c1.c2),
                             "m"((*s2).c1.c3), "m"((*s2).c2.c1),
                             "m"((*s2).c2.c2), "m"((*s2).c2.c3),
                             "m"((*s2).c3.c1), "m"((*s2).c3.c2)
                           : "xmm0", "xmm1");
      ...
      __asm__ __volatile__("vmovsldup %0, %%ymm2 \n\t"
                           ...
                           "vmovshdup %4, %%ymm5"
                           :
                           : "m"((*s1).c1.c1), "m"((*s1).c1.c2),
                             "m"((*s1).c1.c3), "m"((*s1).c2.c1),
                             "m"((*s1).c2.c2), "m"((*s1).c2.c3),
                             "m"((*s1).c3.c1), "m"((*s1).c3.c2)
                           : "xmm2", "xmm3", "xmm4", "xmm5");
      ...
      __asm__ __volatile__("vmovaps %0, %%ymm0 \n\t"
                           "vmovaps %4, %%ymm1"
                           :
                           : "m"((*s2).c3.c3), "m"((*s2).c4.c1),
                             "m"((*s2).c4.c2), "m"((*s2).c4.c3),
                             "m"((*(s2 + 1)).c1.c1), "m"((*(s2 + 1)).c1.c2),
                             "m"((*(s2 + 1)).c1.c3), "m"((*(s2 + 1)).c2.c1)
                           : "xmm0", "xmm1");
      ...
      __asm__ __volatile__("vmovsldup %0, %%ymm2 \n\t"
                           ...
                           "vmovshdup %4, %%ymm5"
                           :
                           : "m"((*s1).c3.c3), "m"((*s1).c4.c1),
                             "m"((*s1).c4.c2), "m"((*s1).c4.c3),
                             "m"((*(s1 + 1)).c1.c1), "m"((*(s1 + 1)).c1.c2),
                             "m"((*(s1 + 1)).c1.c3), "m"((*(s1 + 1)).c2.c1)
                           : "xmm2", "xmm3", "xmm4", "xmm5");
      ...
      __asm__ __volatile__("vmovaps %0, %%ymm0 \n\t"
                           "vmovaps %4, %%ymm1"
                           :
                           : "m"((*(s2 + 1)).c2.c2), "m"((*(s2 + 1)).c2.c3),
                             "m"((*(s2 + 1)).c3.c1), "m"((*(s2 + 1)).c3.c2),
                             "m"((*(s2 + 1)).c3.c3), "m"((*(s2 + 1)).c4.c1),
                             "m"((*(s2 + 1)).c4.c2), "m"((*(s2 + 1)).c4.c3)
                           : "xmm0", "xmm1");
      ...
      __asm__ __volatile__("vmovsldup %0, %%ymm2 \n\t"
                           ...
                           "vmovshdup %4, %%ymm5"
                           :
                           : "m"((*(s1 + 1)).c2.c2), "m"((*(s1 + 1)).c2.c3),
                             "m"((*(s1 + 1)).c3.c1), "m"((*(s1 + 1)).c3.c2),
                             "m"((*(s1 + 1)).c3.c3), "m"((*(s1 + 1)).c4.c1),
                             "m"((*(s1 + 1)).c4.c2), "m"((*(s1 + 1)).c4.c3)
                           : "xmm2", "xmm3", "xmm4", "xmm5");
...
static void linear_cmbs(float *r, complex *z)
{
  ...
  while (s0 < sm) {
    ...
    __asm__ __volatile__("vmovaps %0, %%ymm9 \n\t"
                         "vmovaps %4, %%ymm10"
                         :
                         : "m"((*s2).c1.c1), "m"((*s2).c1.c2), "m"((*s2).c1.c3),
                           "m"((*s2).c2.c1), "m"((*s2).c2.c2), "m"((*s2).c2.c3),
                           "m"((*s2).c3.c1), "m"((*s2).c3.c2)
                         : "xmm9", "xmm10");

    __asm__ __volatile__("vmovaps %0, %%ymm11"
                         :
                         : "m"((*s2).c3.c3), "m"((*s2).c4.c1), "m"((*s2).c4.c2),
                           "m"((*s2).c4.c3)
                         : "xmm11");
...
static void scalar_prods(float *r, complex *z)
{
  ...
  for (; s1 < sm; s1++) {
    ...
    __asm__ __volatile__("vmovsldup %0, %%ymm3 \n\t"
                         "vmovsldup %4, %%ymm4"
                         :
                         : "m"((*s1).c1.c1), "m"((*s1).c1.c2), "m"((*s1).c1.c3),
                           "m"((*s1).c2.c1), "m"((*s1).c2.c2), "m"((*s1).c2.c3),
                           "m"((*s1).c3.c1), "m"((*s1).c3.c2)
                         : "xmm3", "xmm4");
    ...
    __asm__ __volatile__("vmovsldup %0, %%ymm5 \n\t"
                         "vmovshdup %4, %%ymm6"
                         :
                         : "m"((*s1).c3.c3), "m"((*s1).c4.c1), "m"((*s1).c4.c2),
                           "m"((*s1).c4.c3), "m"((*s1).c1.c1), "m"((*s1).c1.c2),
                           "m"((*s1).c1.c3), "m"((*s1).c2.c1)
                         : "xmm5", "xmm6");
    ...
    __asm__ __volatile__("vmovshdup %0, %%ymm7 \n\t"
                         "vmovshdup %4, %%ymm8"
                         :
                         : "m"((*s1).c2.c2), "m"((*s1).c2.c3), "m"((*s1).c3.c1),
                           "m"((*s1).c3.c2), "m"((*s1).c3.c3), "m"((*s1).c4.c1),
                           "m"((*s1).c4.c2), "m"((*s1).c4.c3)
                         : "xmm7", "xmm8");
  ...
  __asm__ __volatile__("vextractf128 $0x1, %%ymm12, %%xmm3 \n\t"
                       ...
                       :
                       :
                       : "xmm3", "xmm4", "xmm5", "xmm12", "xmm13", "xmm14");
...
static void linear_cmbs(float *r, complex *z)
{
  ...
  for (; s0 < sm; s0++) {
    ...
    __asm__ __volatile__("vaddps %0, %%ymm3, %%ymm3"
                         :
                         : "m"((*s0).c1.c1), "m"((*s0).c1.c2), "m"((*s0).c1.c3),
                           "m"((*s0).c2.c1)
                         : "xmm3");

    __asm__ __volatile__("vaddps %0, %%ymm4, %%ymm4"
                         :
                         : "m"((*s0).c2.c2), "m"((*s0).c2.c3), "m"((*s0).c3.c1),
                           "m"((*s0).c3.c2)
                         : "xmm4");

    __asm__ __volatile__("vaddps %0, %%ymm5, %%ymm5"
                         :
                         : "m"((*s0).c3.c3), "m"((*s0).c4.c1), "m"((*s0).c4.c2),
                           "m"((*s0).c4.c3)
                         : "xmm5");
...
static void scalar_prods(float *r, complex *z)
{
  ...
  for (; s1 < sm; s1++) {
    ...
    __asm__ __volatile__("movsldup %0, %%xmm4 \n\t"
                         ...
                         : "m"((*s1).c1.c1), "m"((*s1).c1.c2), "m"((*s1).c1.c3),
                           "m"((*s1).c2.c1), "m"((*s1).c2.c2), "m"((*s1).c2.c3)
                         : "xmm4", "xmm5", "xmm6", "xmm8", "xmm9", "xmm10");
    ...
    __asm__ __volatile__("movaps %0, %%xmm1 \n\t"
                         ...
                         "movaps %4, %%xmm3"
                         :
                         : "m"((*s2).c3.c1), "m"((*s2).c3.c2), "m"((*s2).c3.c3),
                           "m"((*s2).c4.c1), "m"((*s2).c4.c2), "m"((*s2).c4.c3)
                         : "xmm1", "xmm2", "xmm3");
    ...
    __asm__ __volatile__("movsldup %0, %%xmm5 \n\t"
                         ...
                         "movshdup %4, %%xmm11"
                         :
                         : "m"((*s1).c3.c1), "m"((*s1).c3.c2), "m"((*s1).c3.c3),
                           "m"((*s1).c4.c1), "m"((*s1).c4.c2), "m"((*s1).c4.c3)
                         : "xmm5", "xmm6", "xmm7", "xmm9", "xmm10", "xmm11");
...
static void linear_cmbs(float *r, complex *z)
{
  ...
  __asm__ __volatile__("movss %0, %%xmm4 \n\t"
                       ...
                       "mulps %1, %%xmm7"
                       :
                       : "m"(*r), "m"(_sse_sgn13), "m"((*z).re), "m"((*z).im)
                       : "xmm4", "xmm5", "xmm6", "xmm7");
  ...
  for (; s0 < sm; s0++) {
    ...
    __asm__ __volatile__("movaps %0, %%xmm11 \n\t"
                         ...
                         :
                         : "m"((*s0).c1.c1), "m"((*s0).c1.c2), "m"((*s0).c1.c3),
                           "m"((*s0).c2.c1), "m"((*s0).c2.c2), "m"((*s0).c2.c3)
                         : "xmm3", "xmm4", "xmm5", "xmm11", "xmm12", "xmm13");

    __asm__ __volatile__("movaps %%xmm11, %0 \n\t"
                         "movaps %%xmm12, %2 \n\t"
                         "movaps %%xmm13, %4"
                         : "=m"((*s0).c1.c1), "=m"((*s0).c1.c2),
                           "=m"((*s0).c1.c3), "=m"((*s0).c2.c1),
                           "=m"((*s0).c2.c2), "=m"((*s0).c2.c3));
    ...
    __asm__ __volatile__("movaps %0, %%xmm11 \n\t"
                         ...
                         "subps %%xmm5, %%xmm13"
                         :
                         : "m"((*s0).c3.c1), "m"((*s0).c3.c2), "m"((*s0).c3.c3),
                           "m"((*s0).c4.c1), "m"((*s0).c4.c2), "m"((*s0).c4.c3)
                         : "xmm3", "xmm4", "xmm5", "xmm11", "xmm12", "xmm13");

    __asm__ __volatile__("movaps %%xmm11, %0 \n\t"
                         "movaps %%xmm12, %2 \n\t"
                         "movaps %%xmm13, %4"
                         : "=m"((*s0).c3.c1), "=m"((*s0).c3.c2),
                           "=m"((*s0).c3.c3), "=m"((*s0).c4.c1),
                           "=m"((*s0).c4.c2), "=m"((*s0).c4.c3));
