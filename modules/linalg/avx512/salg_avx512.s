...
# mark_description " -isystem /cineca/prod/opt/compilers/intel/pe-xe-2018/binary/impi/2018.1.163/include64/ -DNPROC0=1 -DNPROC1=";
# mark_description "1 -DNPROC2=1 -DNPROC3=1 -DL0=8 -DL1=8 -DL2=8 -DL3=8 -DNPROC0_BLK=1 -DNPROC1_BLK=1 -DNPROC2_BLK=1 -DNPROC3_BL";
# mark_description "K=1 -std=c89 -xCORE-AVX512 -mtune=skylake -DAVX512 -O3 -Ddirac_counters -pedantic -fstrict-aliasing -Wno-lon";
# mark_description "g-long -Wstrict-prototypes -S";
	.file "salg_avx512.c"
	.text
..TXTST0:
