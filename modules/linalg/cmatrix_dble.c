    ...
    for (; w < wm; w += 4) {
      ...
      for (vv = v; vv < vm; vv += 2) {
        ...
        __asm__ __volatile__("vmovapd %0, %%ymm6 \n\t"
                             ...
                             "vmovapd %6, %%ymm9"
                             :
                             : "m"(b[0][0]), "m"(b[0][1]), "m"(b[1][0]),
                               "m"(b[1][1]), "m"(b[2][0]), "m"(b[2][1]),
                               "m"(b[3][0]), "m"(b[3][1])
                             : "xmm6", "xmm7", "xmm8", "xmm9");
    ...
    for (; w < wm; w++) {
      ...
      for (vv = v; vv < vm; vv += 2) {
        __asm__ __volatile__("vmovupd %0, %%ymm6 \n\t"
                             ...
                             :
                             : "m"(b[0][0]), "m"(b[0][1]), "m"(vv[0].re),
                               "m"(vv[1].re), "m"(vv[0].im), "m"(vv[1].im)
    ...
    for (; w < wm; w++) {
      ...
      for (vv = v; vv < vm; vv += 4) {
        __asm__ __volatile__("vmovddup %0, %%ymm4 \n\t"
                             ...
                             "vmovddup %6, %%ymm7"
                             :
                             : "m"(a[0].re), "m"(a[1].re), "m"(a[2].re),
                               "m"(a[3].re), "m"(a[0].im), "m"(a[1].im),
                               "m"(a[2].im), "m"(a[3].im)
                             : "xmm4", "xmm5", "xmm6", "xmm7");
    ...
    for (; w < wm; w++) {
      ...
      for (vv = v; vv < vm; vv += 2) {
        __asm__ __volatile__("vmovddup %0, %%ymm4 \n\t"
                             ...
                             :
                             : "m"(a[0].re), "m"(a[1].re), "m"(a[0].im),
                               "m"(a[1].im), "m"(vv[0]), "m"(vv[1])
                             : "xmm0", "xmm1", "xmm4", "xmm5", "xmm6", "xmm7");
...
static void alloc_arrays(int n)
{
  ...
  if (n > 0) {
    ...
    error_loc((rsv == NULL) || (dsv == NULL), 1,
              "alloc_arrays [cmatrix_dble.c]",
