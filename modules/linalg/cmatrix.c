    ...
    for (; w < wm; w += 4) {
      ...
      for (vv = v; vv < vm; vv += 4) {
        ...
        __asm__ __volatile__("vmovups %0, %%ymm8 \n\t"
                             "vmovups %4, %%ymm9"
                             :
                             : "m"(b[2][0]), "m"(b[2][1]), "m"(b[2][2]),
                               "m"(b[2][3]), "m"(b[3][0]), "m"(b[3][1]),
                               "m"(b[3][2]), "m"(b[3][3])
                             : "xmm8", "xmm9");
        ...
        __asm__ __volatile__("vpermilps $0xb1, %%ymm6, %%ymm10 \n\t"
                             ...
                             :
                             :
                             : "xmm0", "xmm1", "xmm2", "xmm3", "xmm10", "xmm11",
                               "xmm12", "xmm13");
  ...
  if ((n & 0x3) == 0x0) {
    ...
    for (; w < wm; w += 2) {
      ...
      __asm__ __volatile__(
          ...
          :
          : "m"(vv[0]), "m"(vv[1]), "m"(a[0]), "m"(a[1]), "m"(b[0]), "m"(b[1])
          : "xmm0", "xmm2", "xmm4", "xmm5", "xmm6", "xmm7", "xmm8", "xmm9");
    ...
    __asm__ __volatile__("vxorps %%ymm9, %%ymm9, %%ymm9" : : : "xmm9");
