                    ...
                    int nsd, int shf)
{
  ...
  error_root((bo[0] < 0) || ((bo[0] + bs[0]) > L0) || (bs[0] < 4) ||
                 ((bs[0] % 2) != 0) || (bo[1] < 0) || ((bo[1] + bs[1]) > L1) ||
                 (bs[1] < 4) || ((bs[1] % 2) != 0) || (bo[2] < 0) ||
                 ((bo[2] + bs[2]) > L2) || (bs[2] < 4) || ((bs[2] % 2) != 0) ||
                 (bo[3] < 0) || ((bo[3] + bs[3]) > L3) || (bs[3] < 4) ||
                 ((bs[3] % 2) != 0),
             1, "new_blk [block.c]",
             "Improper choice of block position or size");
...
void alloc_blk(block_t *b, int *bo, int *bs, int iu, int iud, int ns, int nsd)
{
  ...
  if (NPROC > 1) {
    ...
    error((ie) || (iprms[8] != iu) || (iprms[9] != iud) || (iprms[10] != ns) ||
              (iprms[11] != nsd),
          1, "alloc_blk [block.c]", "Parameters are not global");
  }
...
void alloc_bnd(block_t *b, int iu, int iud, int nw, int nwd)
{
  ...
  error(fnd_blk(b) == 0, 1, "alloc_bnd [block.c]", "Block is not allocated");
  error((*b).shf & 0x1, 1, "alloc_bnd [block.c]", "Protected block");
  ...
  if (NPROC > 1) {
    ...
    error((ie) || (iprms[8] != iu) || (iprms[9] != iud) || (iprms[10] != nw) ||
              (iprms[11] != nwd),
          1, "alloc_bnd [block.c]", "Parameters are not global");
  }
...
void clone_blk(block_t *b, int shf, int *bo, block_t *c)
{
  ...
  if (NPROC > 1) {
    ...
    error((ie) || (iprms[12] != bshf) || (iprms[13] != iu) ||
              (iprms[14] != iud) || (iprms[15] != ns) || (iprms[16] != nsd) ||
              (iprms[17] != iub) || (iprms[18] != iudb) || (iprms[19] != nw) ||
              (iprms[20] != nwd) || (iprms[21] != ib) || (iprms[22] != shf),
          1, "clone_blk [block.c]", "Parameters are not global");
  }

  error_root((bo[0] < 0) || ((bo[0] + bs[0]) > L0) ||
                 ((abs(bo[0] - bbo[0]) % bs[0]) != 0) || (bo[1] < 0) ||
                 ((bo[1] + bs[1]) > L1) ||
                 ((abs(bo[1] - bbo[1]) % bs[1]) != 0) || (bo[2] < 0) ||
                 ((bo[2] + bs[2]) > L2) ||
                 ((abs(bo[2] - bbo[2]) % bs[2]) != 0) || (bo[3] < 0) ||
                 ((bo[3] + bs[3]) > L3) || ((abs(bo[3] - bbo[3]) % bs[3]) != 0),
             1, "clone_blk [block.c]", "Improper block offset");

  error_root(((bshf & 0x2) && (!(shf & 0x2))) ||
                 ((bshf & 0x4) && (!(shf & 0x4)) && (iu != 0)) ||
                 ((bshf & 0x8) && (!(shf & 0x8)) && (iud != 0)) ||
                 ((bshf & 0x10) && (!(shf & 0x10)) && (ns > 0)) ||
                 ((bshf & 0x20) && (!(shf & 0x20)) && (nsd > 0)),
             1, "clone_blk [block.c]", "Share flag mismatch");
  ...
  if (ib) {
    error_root(((bshf & 0x4) && (!(shf & 0x4)) && (iub != 0)) ||
                   ...
                   ((bshf & 0x80) && (!(shf & 0x80)) && (nwd > 0)),
               2, "clone_blk [block.c]", "Share flag mismatch");
