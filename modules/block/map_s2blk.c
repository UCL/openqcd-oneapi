...
void assign_s2sblk(blk_grid_t grid, int n, ptset_t set, spinor const *s, int k)
{
  ...
  for (; sb < sm; sb++) {
    ...
    __asm__ __volatile__("movaps %0, %%xmm0 \n\t"
                         ...
                         "movaps %4, %%xmm2"
                         :
                         : "m"((*rs1).c1.c1), "m"((*rs1).c1.c2),
                           "m"((*rs1).c1.c3), "m"((*rs1).c2.c1),
                           "m"((*rs1).c2.c2), "m"((*rs1).c2.c3)
                         : "xmm0", "xmm1", "xmm2");
    ...
    __asm__ __volatile__("movaps %0, %%xmm3 \n\t"
                         ...
                         "movaps %4, %%xmm5"
                         :
                         : "m"((*rs1).c3.c1), "m"((*rs1).c3.c2),
                           "m"((*rs1).c3.c3), "m"((*rs1).c4.c1),
                           "m"((*rs1).c4.c2), "m"((*rs1).c4.c3)
                         : "xmm3", "xmm4", "xmm5");

    __asm__ __volatile__("movaps %%xmm0, %0 \n\t"
                         "movaps %%xmm1, %2 \n\t"
                         "movaps %%xmm2, %4"
                         : "=m"((*sb).c1.c1), "=m"((*sb).c1.c2),
                           "=m"((*sb).c1.c3), "=m"((*sb).c2.c1),
                           "=m"((*sb).c2.c2), "=m"((*sb).c2.c3));

    __asm__ __volatile__("movaps %%xmm3, %0 \n\t"
                         "movaps %%xmm4, %2 \n\t"
                         "movaps %%xmm5, %4"
                         : "=m"((*sb).c3.c1), "=m"((*sb).c3.c2),
                           "=m"((*sb).c3.c3), "=m"((*sb).c4.c1),
                           "=m"((*sb).c4.c2), "=m"((*sb).c4.c3));
  }
}
...
void assign_sblk2s(blk_grid_t grid, int n, ptset_t set, int k, spinor *s)
{
  ...
  for (; sb < sm; sb++) {
    ...
    __asm__ __volatile__("movaps %0, %%xmm0 \n\t"
                         ...
                         "movaps %4, %%xmm2"
                         :
                         : "m"((*sb).c1.c1), "m"((*sb).c1.c2), "m"((*sb).c1.c3),
                           "m"((*sb).c2.c1), "m"((*sb).c2.c2), "m"((*sb).c2.c3)
                         : "xmm0", "xmm1", "xmm2");
    ...
    __asm__ __volatile__("movaps %0, %%xmm3 \n\t"
                         ...
                         "movaps %4, %%xmm5"
                         :
                         : "m"((*sb).c3.c1), "m"((*sb).c3.c2), "m"((*sb).c3.c3),
                           "m"((*sb).c4.c1), "m"((*sb).c4.c2), "m"((*sb).c4.c3)
                         : "xmm3", "xmm4", "xmm5");
...
void assign_sdblk2sd(blk_grid_t grid, int n, ptset_t set, int k,
                     spinor_dble *sd)
{
  int nb, isw, vol, *imb;
