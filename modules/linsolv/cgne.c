...
static void update_xp(int vol)
{
  ...
  for (; t < tm; t++) {
    ...
    __asm__ __volatile__("mulps %%xmm6, %%xmm0 \n\t"
                         ...
                         "addps %4, %%xmm2"
                         :
                         : "m"((*t).c1.c1), "m"((*t).c1.c2), "m"((*t).c1.c3),
                           "m"((*t).c2.c1), "m"((*t).c2.c2), "m"((*t).c2.c3)
                         : "xmm0", "xmm1", "xmm2", "xmm3", "xmm4", "xmm5");
    ...
    __asm__ __volatile__("addps %0, %%xmm3 \n\t"
                         ...
                         "addps %4, %%xmm5"
                         :
                         : "m"((*t).c3.c1), "m"((*t).c3.c2), "m"((*t).c3.c3),
                           "m"((*t).c4.c1), "m"((*t).c4.c2), "m"((*t).c4.c3)
                         : "xmm3", "xmm4", "xmm5");
...
double cgne(int vol, int icom, void (*Dop)(spinor *s, spinor *r),
            void (*Dop_dble)(spinor_dble *s, spinor_dble *r), spinor **ws,
            ...
            spinor_dble *psi, int *status)
{
  ...
  if ((icom == 1) && (NPROC > 1)) {
    ...
    if ((vol <= 0) || (nmx < 1) || (res <= DBL_EPSILON)) {
      error_loc(1, 1, "cgne [cgne.c]", "Improper choice of vol,nmx or res");
      (*status) = 0;
      return 1.0;
    }
  }
