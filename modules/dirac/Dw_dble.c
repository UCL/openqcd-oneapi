...
void doe_dble_avx512(const int *piup, const int *pidn, const su3_dble *u, const spinor_dble *pk, double coe, double gamma_f, double one_over_gammaf, spin_t *rs );
static void doe_dble(const int *piup, const int *pidn, const su3_dble *u, const spinor_dble *pk){
  doe_dble_avx512(piup, pidn, u, pk, coe, gamma_f, one_over_gammaf, &rs);
}

void deo_dble_avx512(const int *piup, const int *pidn, const su3_dble *u, spinor_dble *pl, double ceo, double gamma_f, double one_over_gammaf, spin_t *rs);
static void deo_dble(const int *piup, const int *pidn, const su3_dble *u,  spinor_dble *pl){
  deo_dble_avx512(piup, pidn, u, pl, ceo, gamma_f, one_over_gammaf, &rs);
}
