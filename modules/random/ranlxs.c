...
void rlxs_reset(int state[])
{
  ...
  error_loc(((state[97] != 0) && (state[97] != 1)) ||
            ...
            1, "rlxs_reset [ranlxs.c]", "Unexpected input data");
  ...
  error_loc(((pr != 109) && (pr != 202) && (pr != 397)) || (ir < 0) ||
                (ir > 11) || (jr < 0) || (jr > 11) || (jr != ((ir + 7) % 12)) ||
                (is < 0) || (is > 95),
            1, "rlxs_reset [ranlxs.c]", "Unexpected input data");
}
