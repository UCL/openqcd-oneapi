 ...
 *
 *   void cm3x3_swap(int vol, su3_dble const *u, su3_dble *v)
...
void cm3x3_zero(int vol, su3_dble *u)
{
  ...
  for (; u < um; u++) {
    __asm__ __volatile__("movapd %%xmm0, %0 \n\t"
                         "movapd %%xmm1, %1 \n\t"
                         "movapd %%xmm2, %2"
                         : "=m"((*u).c11), "=m"((*u).c12), "=m"((*u).c13));

    __asm__ __volatile__("movapd %%xmm0, %0 \n\t"
                         "movapd %%xmm1, %1 \n\t"
                         "movapd %%xmm2, %2"
                         : "=m"((*u).c21), "=m"((*u).c22), "=m"((*u).c23));

    __asm__ __volatile__("movapd %%xmm0, %0 \n\t"
                         "movapd %%xmm1, %1 \n\t"
                         "movapd %%xmm2, %2"
                         : "=m"((*u).c31), "=m"((*u).c32), "=m"((*u).c33));
  }
}
...
void cm3x3_dagger(su3_dble const *u, su3_dble *v)
{
  ...
  __asm__ __volatile__("movapd %3, %%xmm2 \n\t"
                       ...
                       "movapd %%xmm3, %1 \n\t"
                       "movapd %%xmm4, %2"
                       : "=m"((*v).c11), "=m"((*v).c21), "=m"((*v).c12)
                       : "m"((*u).c11), "m"((*u).c12), "m"((*u).c21)
                       : "xmm2", "xmm3", "xmm4");
  ...
  __asm__ __volatile__("movapd %3, %%xmm5 \n\t"
                       ...
                       "movapd %%xmm6, %1 \n\t"
                       "movapd %%xmm7, %2"
                       : "=m"((*v).c22), "=m"((*v).c31), "=m"((*v).c13)
                       : "m"((*u).c22), "m"((*u).c13), "m"((*u).c31)
                       : "xmm5", "xmm6", "xmm7");
  ...
  __asm__ __volatile__("movapd %3, %%xmm8 \n\t"
                       ...
                       "movapd %%xmm9, %1 \n\t"
                       "movapd %%xmm10, %2"
                       : "=m"((*v).c33), "=m"((*v).c32), "=m"((*v).c23)
                       : "m"((*u).c33), "m"((*u).c23), "m"((*u).c32)
                       : "xmm8", "xmm9", "xmm10");
}
...
void cm3x3_tr(su3_dble const *u, su3_dble const *v, complex_dble *tr)
{
  __asm__ __volatile__("movddup %0, %%xmm0 \n\t"
                       ...
                       "movddup %5, %%xmm5"
                       :
                       : "m"((*u).c11.im), "m"((*u).c12.im), "m"((*u).c13.im),
  ...
  __asm__ __volatile__("movddup %0, %%xmm6 \n\t"
                       ...
                       "movddup %5, %%xmm11"
                       :
                       : "m"((*u).c21.im), "m"((*u).c22.im), "m"((*u).c23.im),
                         "m"((*u).c21.re), "m"((*u).c22.re), "m"((*u).c23.re)
  ...
  __asm__ __volatile__("movddup %0, %%xmm6 \n\t"
                       ...
                       : "m"((*u).c31.im), "m"((*u).c32.im), "m"((*u).c33.im),
                         "m"((*u).c31.re), "m"((*u).c32.re), "m"((*u).c33.re)
                       : "xmm6", "xmm7", "xmm8", "xmm9", "xmm10", "xmm11");
...
void cm3x3_mulc(complex_dble const *c, su3_dble const *u, su3_dble *v)
{
  ...
  __asm__ __volatile__("movddup %0, %%xmm2 \n\t"
                       ...
                       "mulpd %%xmm1, %%xmm7"
                       :
                       : "m"((*u).c11.re), "m"((*u).c11.im), "m"((*u).c12.re),
                         "m"((*u).c12.im), "m"((*u).c13.re), "m"((*u).c13.im)
  ...
  __asm__ __volatile__("movddup %0, %%xmm8 \n\t"
                       ...
                       "mulpd %%xmm1, %%xmm13"
                       :
                       : "m"((*u).c21.re), "m"((*u).c21.im), "m"((*u).c22.re),
                         "m"((*u).c22.im), "m"((*u).c23.re), "m"((*u).c23.im)
  ...
  __asm__ __volatile__("movddup %0, %%xmm2 \n\t"
                       ...
                       "mulpd %%xmm1, %%xmm7"
                       :
                       : "m"((*u).c31.re), "m"((*u).c31.im), "m"((*u).c32.re),
                         "m"((*u).c32.im), "m"((*u).c33.re), "m"((*u).c33.im)
                       : "xmm2", "xmm3", "xmm4", "xmm5", "xmm6", "xmm7");
