...
void su3xu3alg(su3_dble const *u, u3_alg_dble const *X, su3_dble *v)
{
  __asm__ __volatile__("vxorpd %%ymm5, %%ymm5, %%ymm5 \n\t"
                       ...
                       :
                       : "m"((*X).c4), "m"((*X).c5), "m"((*X).c6), "m"((*X).c7),
                         "m"((*X).c1), "m"((*X).c2), "m"((*X).c8), "m"((*X).c9),
                         "m"(_sse_sgn1_dble)
...
void rotate_su3alg(su3_dble const *u, su3_alg_dble *X)
{
  ...
  __asm__ __volatile__("vaddsubpd %%xmm2, %%xmm5, %%xmm6 \n\t"
                       ...
                       "vmovapd %%xmm7, %4 \n\t"
                       "vmovapd %%xmm8, %5"
                       : "=m"(uX.c12), "=m"(uX.c13), "=m"(uX.c23), "=m"(uX.c21),
                         "=m"(uX.c31), "=m"(uX.c32)
                       :
                       : "xmm6", "xmm7", "xmm8");
...
void su3dagxu3alg(su3_dble const *u, u3_alg_dble const *X, su3_dble *v)
{
  __asm__ __volatile__("xorpd %%xmm0, %%xmm0\n\t"
                       ...
                       "mulpd %5, %%xmm2"
                       :
                       : "m"((*X).c1), "m"((*X).c4), "m"((*X).c5), "m"((*X).c6),
                         "m"((*X).c7), "m"(_sse_sgn1_dble)
                       : "xmm0", "xmm1", "xmm2");
  su3dagxsu3vec(u);
  __asm__ __volatile__("movapd %%xmm3, %0 \n\t"
                       "movapd %%xmm4, %1 \n\t"
  ...
  __asm__ __volatile__("movupd %0, %%xmm0 \n\t"
                       ...
                       "mulpd %5, %%xmm2"
                       :
                       : "m"((*X).c4), "m"((*X).c5), "m"((*X).c2), "m"((*X).c8),
                         "m"((*X).c9), "m"(_sse_sgn1_dble)
                       : "xmm0", "xmm1", "xmm2");
  su3dagxsu3vec(u);
  __asm__ __volatile__("movapd %%xmm3, %0 \n\t"
                       "movapd %%xmm4, %1 \n\t"
...
void prod2u3alg(su3_dble const *u, su3_dble const *v, u3_alg_dble *X)
{
  ...
  __asm__ __volatile__("movupd %0, %%xmm6 \n\t"
                       ...
                       "addsd %%xmm4, %%xmm4"
                       :
                       : "m"((*X).c4), "m"((*X).c5), "m"(_sse_sgn1_dble)
                       : "xmm3", "xmm4", "xmm5", "xmm6");

  __asm__ __volatile__("movupd %%xmm5, %0 \n\t"
                       "movupd %%xmm3, %2 \n\t"
                       "movlpd %%xmm4, %4"
                       : "=m"((*X).c8), "=m"((*X).c9), "=m"((*X).c4),
                         "=m"((*X).c5), "=m"((*X).c2));
...
void rotate_su3alg(su3_dble const *u, su3_alg_dble *X)
{
  ...
  __asm__ __volatile__("shufpd $0x1, %%xmm0, %%xmm0 \n\t"
                       ...
                       "movlpd %%xmm3, %4 \n\t"
                       "movlpd %%xmm3, %5"
                       : "=m"(uX.c11.im), "=m"(uX.c22.im), "=m"(uX.c33.im),
                         "=m"(uX.c11.re), "=m"(uX.c22.re), "=m"(uX.c33.re)
                       :
                       : "xmm0", "xmm1", "xmm2", "xmm3");
  ...
  __asm__ __volatile__("movapd %%xmm3, %0 \n\t"
                       ...
                       "subpd %4, %%xmm4"
                       : "=m"((*X).c3), "=m"((*X).c4)
                       : "m"(_sse_sgn1_dble), "m"(_sse_sgn2_dble), "m"((*X).c1),
                         "m"((*X).c2)
                       : "xmm4", "xmm5");
