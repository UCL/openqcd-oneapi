...
static void test1(blk_grid_t grid, int *bs)
{
  ...
  error(((*b).bo[0] != 0) || ((*b).bo[1] != 0) || ((*b).bo[2] != 0) ||
            ((*b).bo[3] != 0),
        1, "test1 [check1.c]", "Offset of the first block is incorrect");

  error((bs[0] != ((*b).bs[0])) || (bs[1] != ((*b).bs[1])) ||
            (bs[2] != ((*b).bs[2])) || (bs[3] != ((*b).bs[3])),
        1, "test1 [check1.c]", "Block sizes are not correctly assigned");
  ...
  error(itest == 4, 1, "test1 [check1.c]",
        "The blocks do not cover the lattice");
}
...
static void test2(blk_grid_t grid)
{
  ...
  error(itest == 1, 1, "test2 [check1.c]", "b.ipt is out of range");
...
static void test3(blk_grid_t grid)
{
  ...
  error(itest == 3, 1, "test3 [check1.c]", "b.ibp is not properly ordered");
...
static void test4(blk_grid_t grid)
{
  ...
  error(itest == 2, 1, "test4 [check1.c]", "bb.ipp is out of range");
  error(itest == 3, 1, "test4 [check1.c]", "bb.imb is out of range");
...
static void test5(blk_grid_t grid)
{
  ...
  error(itest == 4, 1, "test5 [check1.c]", "The block map array is incorrect");
