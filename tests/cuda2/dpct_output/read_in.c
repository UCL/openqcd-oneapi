...
int read_sp_u_from_file(char *cnfg, su3 *u, int vol)
{
  FILE *fin;
  int ix;

  if ((fin = fopen(cnfg, "rb"))) {
...
int read_sp_m_from_file(char *cnfg, pauli *m, int vol)
{
  FILE *fin;
  int ix;
...
int read_sp_spinor_from_file(char *cnfg, spinor *s, int vol)
{
  FILE *fin;
  int ix;
...
int read_lt_from_file(char *cnfg, int *piud, int vol)
{
  FILE *fin;
  int ix;
