...
extern int cheby_fit(double a, double b, double (*f)(double x), int dmax,
                     double eps, double c[]);
extern double cheby_int(double a, double b, double (*f)(double x), int dmax,
                        double eps);
...
extern double minimize_fct(double x0, double x1, double x2,
                           double (*f)(double x), double omega1, double omega2);
...
extern double tauint(int n, double *a, int tmax, int lambda, int *w,
                     double *sigma);
extern double print_auto(int n, double *a);
extern double jack_err(int nx, int n, double **a,
                       double (*f)(int nx, double *x), int bmax, double *sig);
extern double print_jack(int nx, int n, double **a,
