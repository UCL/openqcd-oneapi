...
static avx_double _avx_sgn13_dble
    __attribute__((unused)) = {-1.0, 1.0, -1.0, 1.0};
static avx_double _avx_sgn14_dble
    __attribute__((unused)) = {-1.0, 1.0, 1.0, -1.0};
static avx_double _avx_sgn23_dble
    __attribute__((unused)) = {1.0, -1.0, -1.0, 1.0};
static avx_double _avx_sgn24_dble
    __attribute__((unused)) = {1.0, -1.0, 1.0, -1.0};
static avx_double _avx_sgn34_dble
    __attribute__((unused)) = {1.0, 1.0, -1.0, -1.0};
static avx_double _avx_sgn_dble
    __attribute__((unused)) = {-1.0, -1.0, -1.0, -1.0};
...
#define _avx_zeroall() __asm__ __volatile__("vzeroall")
...
#define _avx_spinor_pair_load34(sl, sh)                                        \
  __asm__ __volatile__("vmovaps %0, %%xmm6 \n\t"                               \
                       ...
                       "vmovaps %4, %%xmm8"                                    \
                       :                                                       \
                       : "m"((sl).c1.c1), "m"((sl).c1.c2), "m"((sl).c1.c3),    \
                         "m"((sl).c2.c1), "m"((sl).c2.c2), "m"((sl).c2.c3)     \
                       : "xmm6", "xmm7", "xmm8");                              \
  __asm__ __volatile__("vmovaps %0, %%xmm9 \n\t"                               \
                       "vmovaps %2, %%xmm10 \n\t"                              \
                       "vmovaps %4, %%xmm11"                                   \
                       :                                                       \
                       : "m"((sl).c3.c1), "m"((sl).c3.c2), "m"((sl).c3.c3),    \
                         "m"((sl).c4.c1), "m"((sl).c4.c2), "m"((sl).c4.c3)     \
                       : "xmm9", "xmm10", "xmm11");                            \
  __asm__ __volatile__("vinsertf128 $0x1, %0, %%ymm6, %%ymm6 \n\t"             \
                       "vinsertf128 $0x1, %2, %%ymm7, %%ymm7 \n\t"             \
                       "vinsertf128 $0x1, %4, %%ymm8, %%ymm8"                  \
                       :                                                       \
                       : "m"((sh).c1.c1), "m"((sh).c1.c2), "m"((sh).c1.c3),    \
                         "m"((sh).c2.c1), "m"((sh).c2.c2), "m"((sh).c2.c3)     \
                       : "xmm6", "xmm7", "xmm8");                              \
  __asm__ __volatile__("vinsertf128 $0x1, %0, %%ymm9, %%ymm9 \n\t"             \
                       "vinsertf128 $0x1, %2, %%ymm10, %%ymm10 \n\t"           \
                       "vinsertf128 $0x1, %4, %%ymm11, %%ymm11"                \
                       :                                                       \
                       : "m"((sh).c3.c1), "m"((sh).c3.c2), "m"((sh).c3.c3),    \
                         "m"((sh).c4.c1), "m"((sh).c4.c2), "m"((sh).c4.c3)     \
                       : "xmm9", "xmm10", "xmm11");                            \
...
#define _avx_spinor_pair_store34(rl, rh)                                       \
  ...
  __asm__ __volatile__("vmovaps %%xmm9, %0 \n\t"                               \
                       "vmovaps %%xmm10, %2 \n\t"                              \
                       "vmovaps %%xmm11, %4"                                   \
                       : "=m"((rl).c3.c1), "=m"((rl).c3.c2), "=m"((rl).c3.c3), \
                         "=m"((rl).c4.c1), "=m"((rl).c4.c2),                   \
                         "=m"((rl).c4.c3));                                    \
...
#define _avx_su3_pair_multiply(ul, uh)                                         \
  __asm__ __volatile__("vbroadcastss %0, %%xmm3 \n\t"                          \
                       ...
                       :                                                       \
                       : "m"((ul).c11.re), "m"((ul).c12.re), "m"((ul).c21.re), \
                         "m"((uh).c11.re), "m"((uh).c12.re), "m"((uh).c21.re)  \
                       : "xmm3", "xmm4", "xmm6", "xmm9", "xmm10", "xmm11");    \
  __asm__ __volatile__("vbroadcastss %0, %%xmm7 \n\t"                          \
                       ...
                       :                                                       \
                       : "m"((ul).c22.re), "m"((ul).c31.re), "m"((ul).c32.re), \
                         "m"((uh).c22.re), "m"((uh).c31.re), "m"((uh).c32.re)  \
                       : "xmm5", "xmm7", "xmm8", "xmm12", "xmm13", "xmm14");   \
  ...
  __asm__ __volatile__("vbroadcastss %0, %%xmm9 \n\t"                          \
                       ...
                       "vpermilps $0xb1, %%ymm0, %%ymm0"                       \
                       :                                                       \
                       : "m"((ul).c13.re), "m"((ul).c21.im), "m"((ul).c33.re), \
                         "m"((uh).c13.re), "m"((uh).c21.im), "m"((uh).c33.re)  \
                       : "xmm0", "xmm9", "xmm10", "xmm11", "xmm12", "xmm13",   \
                         "xmm14");                                             \
  __asm__ __volatile__("vbroadcastss %0, %%xmm6 \n\t"                          \
                       ...
                       "vinsertf128 $0x1, %%xmm14, %%ymm8, %%ymm8"             \
                       :                                                       \
                       : "m"((ul).c11.im), "m"((ul).c23.re), "m"((ul).c31.im), \
                         "m"((uh).c11.im), "m"((uh).c23.re), "m"((uh).c31.im)  \
                       : "xmm6", "xmm7", "xmm8", "xmm12", "xmm13", "xmm14");   \
  ...
  __asm__ __volatile__("vpermilps $0xb1, %%ymm1, %%ymm1 \n\t"                  \
                       ...
                       "vinsertf128 $0x1, %%xmm14, %%ymm11, %%ymm11"           \
                       :                                                       \
                       : "m"((uh).c12.im), "m"((uh).c23.im), "m"((uh).c32.im), \
                         "m"((ul).c12.im), "m"((ul).c23.im), "m"((ul).c32.im)  \
                       : "xmm1", "xmm2", "xmm9", "xmm10", "xmm11", "xmm12",    \
                         "xmm13", "xmm14");                                    \
  __asm__ __volatile__("vbroadcastss %0, %%xmm6 \n\t"                          \
                       "vbroadcastss %1, %%xmm7 \n\t"                          \
                       "vbroadcastss %2, %%xmm8 \n\t"                          \
                       ...
                       "vinsertf128 $0x1, %%xmm14, %%ymm8, %%ymm8"             \
                       :                                                       \
                       : "m"((ul).c13.im), "m"((ul).c22.im), "m"((ul).c33.im), \
                         "m"((uh).c13.im), "m"((uh).c22.im), "m"((uh).c33.im)  \
                       : "xmm6", "xmm7", "xmm8", "xmm12", "xmm13", "xmm14");   \
...
#define _avx_su3_pair_inverse_multiply(ul, uh)                                 \
  __asm__ __volatile__("vbroadcastss %0, %%xmm6 \n\t"                          \
                       ...
                       :                                                       \
                       : "m"((ul).c11.im), "m"((ul).c21.im), "m"((ul).c12.im), \
                         "m"((uh).c11.im), "m"((uh).c21.im), "m"((uh).c12.im)  \
                       : "xmm6", "xmm7", "xmm9", "xmm12", "xmm13", "xmm14");   \
  __asm__ __volatile__("vbroadcastss %0, %%xmm10 \n\t"                         \
                       ...
                       "vinsertf128 $0x1, %%xmm14, %%ymm11, %%ymm11"           \
                       :                                                       \
                       : "m"((ul).c22.im), "m"((ul).c13.im), "m"((ul).c23.im), \
                         "m"((uh).c22.im), "m"((uh).c13.im), "m"((uh).c23.im)  \
                       : "xmm8", "xmm10", "xmm11", "xmm12", "xmm13", "xmm14"); \
  ...
  __asm__ __volatile__("vbroadcastss %0, %%xmm3 \n\t"                          \
                       ...
                       "vpermilps $0xb1, %%ymm0, %%ymm0"                       \
                       :                                                       \
                       : "m"((ul).c11.re), "m"((ul).c12.re), "m"((ul).c13.re), \
                         "m"((uh).c11.re), "m"((uh).c12.re), "m"((uh).c13.re)  \
                       : "xmm0", "xmm3", "xmm4", "xmm5", "xmm12", "xmm13",     \
                         "xmm14");                                             \
  __asm__ __volatile__("vbroadcastss %0, %%xmm6 \n\t"                          \
                       "vbroadcastss %1, %%xmm7 \n\t"                          \
                       "vbroadcastss %2, %%xmm8 \n\t"                          \
                       ...
                       "vinsertf128 $0x1, %%xmm14, %%ymm8, %%ymm8"             \
                       :                                                       \
                       : "m"((ul).c31.im), "m"((ul).c32.im), "m"((ul).c33.im), \
                         "m"((uh).c31.im), "m"((uh).c32.im), "m"((uh).c33.im)  \
                       : "xmm6", "xmm7", "xmm8", "xmm12", "xmm13", "xmm14");   \
  __asm__ __volatile__("vmulps %%ymm0, %%ymm3, %%ymm3 \n\t"                    \
                       "vmulps %%ymm0, %%ymm4, %%ymm4 \n\t"                    \
                       "vmulps %%ymm0, %%ymm5, %%ymm5 \n\t"                    \
  ...
  __asm__ __volatile__("vpermilps $0xb1, %%ymm1, %%ymm1 \n\t"                  \
                       ...
                       "vinsertf128 $0x1, %%xmm14, %%ymm11, %%ymm11"           \
                       :                                                       \
                       : "m"((uh).c21.re), "m"((uh).c32.re), "m"((uh).c23.re), \
                         "m"((ul).c21.re), "m"((ul).c32.re), "m"((ul).c23.re)  \
                       : "xmm1", "xmm2", "xmm9", "xmm10", "xmm11", "xmm12",    \
                         "xmm13", "xmm14");                                    \
  __asm__ __volatile__("vbroadcastss %0, %%xmm6 \n\t"                          \
                       "vbroadcastss %1, %%xmm7 \n\t"                          \
                       ...
                       "vinsertf128 $0x1, %%xmm14, %%ymm8, %%ymm8"             \
                       :                                                       \
                       : "m"((ul).c31.re), "m"((ul).c22.re), "m"((ul).c33.re), \
                         "m"((uh).c31.re), "m"((uh).c22.re), "m"((uh).c33.re)  \
                       : "xmm6", "xmm7", "xmm8", "xmm12", "xmm13", "xmm14");   \
  __asm__ __volatile__("vmulps %%ymm1, %%ymm9, %%ymm9 \n\t"                    \
                       "vmulps %%ymm2, %%ymm10, %%ymm10 \n\t"                  \
                       "vmulps %%ymm1, %%ymm11, %%ymm11 \n\t"                  \
...
#define _avx_su3_pair_mixed_multiply(ul, uh)                                   \
  __asm__ __volatile__("vbroadcastss %0, %%xmm3 \n\t"                          \
                       ...
                       :                                                       \
                       : "m"((ul).c11.re), "m"((ul).c12.re), "m"((ul).c21.re), \
                         "m"((uh).c11.re), "m"((uh).c21.re), "m"((uh).c12.re)  \
                       : "xmm3", "xmm4", "xmm6", "xmm9", "xmm10", "xmm11");    \
  __asm__ __volatile__("vbroadcastss %0, %%xmm7 \n\t"                          \
                       "vbroadcastss %1, %%xmm5 \n\t"                          \
                       "vbroadcastss %2, %%xmm8 \n\t"                          \
                       ...
                       :                                                       \
                       : "m"((ul).c22.re), "m"((ul).c31.re), "m"((ul).c32.re), \
                         "m"((uh).c22.re), "m"((uh).c13.re), "m"((uh).c23.re)  \
                       : "xmm5", "xmm7", "xmm8", "xmm12", "xmm13", "xmm14");   \
  __asm__ __volatile__("vmulps %%ymm0, %%ymm3, %%ymm3 \n\t"                    \
                       "vmulps %%ymm1, %%ymm6, %%ymm6 \n\t"                    \
                       "vmulps %%ymm0, %%ymm4, %%ymm4 \n\t"                    \
  ...
  __asm__ __volatile__("vbroadcastss %0, %%xmm9 \n\t"                          \
                       ...
                       :                                                       \
                       : "m"((ul).c13.re), "m"((ul).c21.im), "m"((ul).c33.re), \
                         "m"((uh).c31.re), "m"((uh).c12.im), "m"((uh).c33.re)  \
                       : "xmm0", "xmm9", "xmm10", "xmm11", "xmm12", "xmm13",   \
                         "xmm14");                                             \
  __asm__ __volatile__("vbroadcastss %0, %%xmm6 \n\t"                          \
                       "vbroadcastss %1, %%xmm7 \n\t"                          \
                       ...
                       :                                                       \
                       : "m"((ul).c11.im), "m"((ul).c23.re), "m"((ul).c31.im), \
                         "m"((uh).c11.im), "m"((uh).c32.re), "m"((uh).c13.im)  \
                       : "xmm6", "xmm7", "xmm8", "xmm12", "xmm13", "xmm14");   \
  __asm__ __volatile__("vmulps %%ymm2, %%ymm9, %%ymm9 \n\t"                    \
                       "vmulps %%ymm0, %%ymm10, %%ymm10 \n\t"                  \
                       "vmulps %%ymm2, %%ymm11, %%ymm11 \n\t"                  \
  ...
  __asm__ __volatile__("vpermilps $0xb1, %%ymm1, %%ymm1 \n\t"                  \
                       ...
                       :                                                       \
                       : "m"((uh).c21.im), "m"((uh).c32.im), "m"((uh).c23.im), \
                         "m"((ul).c12.im), "m"((ul).c23.im), "m"((ul).c32.im)  \
                       : "xmm1", "xmm2", "xmm9", "xmm10", "xmm11", "xmm12",    \
                         "xmm13", "xmm14");                                    \
  __asm__ __volatile__("vbroadcastss %0, %%xmm6 \n\t"                          \
                       ...
                       :                                                       \
                       : "m"((ul).c13.im), "m"((ul).c22.im), "m"((ul).c33.im), \
                         "m"((uh).c31.im), "m"((uh).c22.im), "m"((uh).c33.im)  \
                       : "xmm6", "xmm7", "xmm8", "xmm12", "xmm13", "xmm14");   \
  __asm__ __volatile__("vmulps %%ymm1, %%ymm9, %%ymm9 \n\t"                    \
                       "vmulps %%ymm2, %%ymm10, %%ymm10 \n\t"                  \
                       "vmulps %%ymm1, %%ymm11, %%ymm11 \n\t"                  \
...
#define _avx_pair_load_dble(sl, sh)                                            \
  __asm__ __volatile__("vmovapd %0, %%xmm0 \n\t"                               \
                       ...
                       :                                                       \
                       : "m"((sl).c1), "m"((sl).c2), "m"((sl).c3),             \
                         "m"((sh).c1), "m"((sh).c2), "m"((sh).c3)              \
                       : "xmm0", "xmm1", "xmm2")
...
#define _avx_su3_multiply_pair_dble(u)                                         \
  __asm__ __volatile__("vbroadcastsd %0, %%ymm3 \n\t"                          \
                       ...
                       "vbroadcastsd %5, %%ymm8"                               \
                       :                                                       \
                       : "m"((u).c11.re), "m"((u).c12.re), "m"((u).c21.re),    \
                         "m"((u).c22.re), "m"((u).c31.re), "m"((u).c32.re)     \
                       : "xmm3", "xmm4", "xmm5", "xmm6", "xmm7", "xmm8");      \
  ...
  __asm__ __volatile__("vbroadcastsd %0, %%ymm9 \n\t"                          \
                       ...
                       :                                                       \
                       : "m"((u).c13.re), "m"((u).c21.im), "m"((u).c33.re),    \
                         "m"((u).c11.im), "m"((u).c23.re), "m"((u).c31.im)     \
                       : "xmm0", "xmm6", "xmm7", "xmm8", "xmm9", "xmm10",      \
                         "xmm11");                                             \
  ...
  __asm__ __volatile__("vbroadcastsd %0, %%ymm9 \n\t"                          \
                       ...
                       :                                                       \
                       : "m"((u).c12.im), "m"((u).c23.im), "m"((u).c32.im),    \
                         "m"((u).c13.im), "m"((u).c22.im), "m"((u).c33.im)     \
                       : "xmm1", "xmm2", "xmm6", "xmm7", "xmm8", "xmm9",       \
                         "xmm10", "xmm11");                                    \
