...
extern dfl_gen_parms_t set_dfl_gen_parms(double kappa, double mu, int ninv,
                                         int nmr, int ncy);
...
/* SOLVER_PARMS_C */
extern solver_parms_t set_solver_parms(int isp, solver_t solver, int nkv,
                                       int isolv, int nmr, int ncy, int nmx,
                                       double res);
