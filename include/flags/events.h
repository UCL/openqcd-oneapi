...
static void LatUpdatedU(void) { lat.u = next_tag(); }

static void LatUpdatedUd(void) { lat.ud = next_tag(); }
...
static void LatInvertedSwdE(void) { lat.swd[1] ^= 0x1; }

static void LatInvertedSwdO(void) { lat.swd[2] ^= 0x1; }

static void LatErasedAw(void) { lat.aw = 0; }

static void LatErasedAwhat(void) { lat.awh = 0; }
