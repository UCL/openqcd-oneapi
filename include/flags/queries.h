...
static int QueryUMatchUd(void) { return (lat.u == lat.ud); }
...
static int QuerySwEInverted(void) { return (lat.sw[1] == 1); }

static int QuerySwOInverted(void) { return (lat.sw[2] == 1); }
...
static int QuerySwdEInverted(void) { return (lat.swd[1] == 1); }

static int QuerySwdOInverted(void) { return (lat.swd[2] == 1); }

static int QueryAwUp2date(void) { return ((lat.ud > 0) && (lat.aw == lat.ud)); }
