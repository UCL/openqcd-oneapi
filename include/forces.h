...
/* FORCE2_C */
extern double setpf2(double mu0, double mu1, int ipf, int isp, int icom,
                     int *status);
extern void force2(double mu0, double mu1, int ipf, int isp, int icr, double c,
                   int *status);
extern double action2(double mu0, double mu1, int ipf, int isp, int icom,
                      int *status);
...
extern void force4(double mu, int ipf, int isw, int isp, int icr, double c,
                   int *status);
extern double action4(double mu, int ipf, int isw, int isp, int icom,
                      int *status);

/* FORCE5_C */
extern double setpf5(double mu0, double mu1, int ipf, int isp, int icom,
                     int *status);
extern void force5(double mu0, double mu1, int ipf, int isp, int icr, double c,
                   int *status);
...
/* TMCG_C */
extern double tmcg(int nmx, double res, double mu, spinor_dble *eta,
                   spinor_dble *psi, int *status);
extern double tmcgeo(int nmx, double res, double mu, spinor_dble *eta,
                     spinor_dble *psi, int *status);

/* TMCGM_C */
extern void tmcgm(int nmx, double *res, int nmu, double *mu, spinor_dble *eta,
                  spinor_dble **psi, int *status);
