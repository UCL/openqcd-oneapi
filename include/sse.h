...
static sse_float _sse_sgn13
    __attribute__((unused)) = {-1.0f, 1.0f, -1.0f, 1.0f};
static sse_float _sse_sgn14
    __attribute__((unused)) = {-1.0f, 1.0f, 1.0f, -1.0f};
static sse_float _sse_sgn23
    __attribute__((unused)) = {1.0f, -1.0f, -1.0f, 1.0f};
static sse_float _sse_sgn24
    __attribute__((unused)) = {1.0f, -1.0f, 1.0f, -1.0f};
static sse_float _sse_sgn34
    __attribute__((unused)) = {1.0f, 1.0f, -1.0f, -1.0f};
static sse_float _sse_sgn
    __attribute__((unused)) = {-1.0f, -1.0f, -1.0f, -1.0f};
...
#define _prefetch_128b(addr)                                                   \
  __asm__ __volatile__("prefetcht0 %0" : : "m"(*((char *)(_pfbase(addr)))))
...
#define _prefetch_su3_alg_dble(addr) _prefetch_128b((addr))

#define _prefetch_weyl(addr) _prefetch_256b((addr))

#define _prefetch_spinor(addr) _prefetch_256b((addr))

#define _prefetch_su3(addr) _prefetch_256b((addr))

#define _prefetch_pauli(addr) _prefetch_256b((addr))

#define _prefetch_weyl_dble(addr) _prefetch_256b((addr))

#define _prefetch_spinor_dble(addr) _prefetch_256b((addr))

#define _prefetch_su3_dble(addr) _prefetch_256b((addr))

#define _prefetch_pauli_dble(addr) _prefetch_384b((addr))
...
#define _prefetch_su3_alg_dble(addr) _prefetch_64b((addr))

#define _prefetch_weyl(addr) _prefetch_64b((addr))

#define _prefetch_spinor(addr) _prefetch_128b((addr))

#define _prefetch_su3(addr) _prefetch_128b((addr))

#define _prefetch_pauli(addr) _prefetch_192b((addr))

#define _prefetch_weyl_dble(addr) _prefetch_128b((addr))

#define _prefetch_spinor_dble(addr) _prefetch_192b((addr))

#define _prefetch_su3_dble(addr) _prefetch_192b((addr))

#define _prefetch_pauli_dble(addr) _prefetch_320b((addr))
...
#define _prefetch_spinor(addr) _prefetch_96b((addr))

#define _prefetch_su3(addr) _prefetch_96b((addr))

#define _prefetch_pauli(addr) _prefetch_160b((addr))

#define _prefetch_weyl_dble(addr) _prefetch_96b((addr))

#define _prefetch_spinor_dble(addr) _prefetch_192b((addr))

#define _prefetch_su3_dble(addr) _prefetch_160b((addr))

#define _prefetch_pauli_dble(addr) _prefetch_288b((addr))
...
#define _sse_su3_inverse_multiply(u)                                           \
  __asm__ __volatile__("movss %0, %%xmm6 \n\t"                                 \
                       ...
                       "shufps $0x0, %%xmm11, %%xmm11"                         \
                       :                                                       \
                       : "m"((u).c11.im), "m"((u).c21.im), "m"((u).c12.im),    \
                         "m"((u).c22.im), "m"((u).c13.im), "m"((u).c23.im)     \
  ...
  __asm__ __volatile__("movss %0, %%xmm3 \n\t"                                 \
                       ...
                       "shufps $0x0, %%xmm8, %%xmm8"                           \
                       :                                                       \
                       : "m"((u).c11.re), "m"((u).c12.re), "m"((u).c13.re),    \
                         "m"((u).c31.im), "m"((u).c32.im), "m"((u).c33.im)     \
  ...
  __asm__ __volatile__("movss %0, %%xmm9 \n\t"                                 \
                       ...
                       "shufps $0x0, %%xmm8, %%xmm8"                           \
                       :                                                       \
                       : "m"((u).c21.re), "m"((u).c32.re), "m"((u).c23.re),    \
                         "m"((u).c31.re), "m"((u).c22.re), "m"((u).c33.re)     \
                       : "xmm1", "xmm2", "xmm6", "xmm7", "xmm8", "xmm9",       \
                         "xmm10", "xmm11");                                    \
  __asm__ __volatile__("mulps %%xmm1, %%xmm9 \n\t"                             \
                       "mulps %%xmm2, %%xmm10 \n\t"                            \
